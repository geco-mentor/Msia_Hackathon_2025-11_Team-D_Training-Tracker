...
import { Terminal, Shield, Target, Cpu, MessageSquare, Database, Lock, Activity, LogOut, User, Briefcase, Award, Code, Network, Brain, Ghost } from 'lucide-react';
// Import getRankFromElo from your config
